...
class MultiPathChannelConfig:
    def __init__(
        ...
        Args:
            ...
            aoas (np.ndarray | list): array or list of angle of arrivals. aoas[i] should be either float
                (elevation by default), or two element array ([azimuth, elevation])
            aods (np.ndarray | list): array or list of angle of departures. aods[i] should be either float
                (elevation by default), or two element array ([azimuth, elevation])
        """
        super().__init__()
